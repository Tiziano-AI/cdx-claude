...
CDX_CLAUDE_NPM_SPEC="$PACK_DIR/cdx-claude-0.1.0.tgz" plugin/bin/cdx-claude --help
```
...
Create the public repository `Tiziano-AI/cdx-claude`, push `main`, and tag `v0.1.0` only after preflight passes.
