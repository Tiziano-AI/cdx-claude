...
Push `main` and tag `v0.1.5` only after preflight passes.
...
pnpm release:preflight
codex mcp get cdx-claude
~/.codex/plugins/cache/cdx-claude/cdx-claude/0.1.5/bin/cdx-claude --help
~/.codex/plugins/cache/cdx-claude/cdx-claude/0.1.5/bin/cdx-claude doctor
node scripts/assert-mcp-tools.mjs ~/.codex/plugins/cache/cdx-claude/cdx-claude/0.1.5/bin/cdx-claude ~/.codex/plugins/cache/cdx-claude/cdx-claude/0.1.5
```
